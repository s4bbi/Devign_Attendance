...
const API_BASE = "https://devign-attendance-api.vercel.app/";
...
export default function App() {
  ...
  return (
    <div className="app-root relative flex items-center justify-center px-3 py-6 sm:px-4 sm:py-10">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between px-4 pt-5 sm:px-6 sm:pt-6 md:px-10 md:pt-8">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-1 max-w-md">
                Capture who showed up for today&apos;s creative session, cleanly
                and effortlessly.
              </p>
            </div>
